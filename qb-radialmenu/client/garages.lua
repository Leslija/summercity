...
JobGaragez = {
    {
        ["zone"] = BoxZone:Create(vector3(442.44, -1026.08, 28.54), 5.6, 18.2, {
            name="police",
            heading=5,
            debugPoly=false,
            minZ=26.54,
    ...
    {
        ["zone"] = BoxZone:Create(vector3(445.57, -991.85, 25.7), 14.4, 5.0, {
            name="police",
            heading=0,
            debugPoly=false,
            minZ=23.1,
    ...
    {
        ["zone"] = BoxZone:Create(vector3(437.56, -991.46, 25.7), 14.4, 5.0, {
            name="police",
            heading=0,
            debugPoly=false,
            minZ=23.1,
...
Depotz = {
    {
        ...
        ["zone"] = BoxZone:Create(vector3(-143.89, -1173.01, 23.77), 26.4, 28.6, {
            name="hayesdepot",
            heading = 0,
            minZ = 21.77,
            maxZ = 25.77
        ...
        if not IsPedInAnyVehicle(PlayerPedId()) and inRange and currentGarage then 
            if Garages[currentGarage] then
                Config.MenuItems[3].items[itemdata] = {
                    ...
                    icon = 'car',
                    type = 'client',
                    event = 'qb-garages:client:OpenMenu', -- qb-garages:client:VehicleList  qb-garages:client:takeOutPublicGarage
                    shouldClose = true
                }
