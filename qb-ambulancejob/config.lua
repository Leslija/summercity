...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["beds"] = {
        [1] = {coords = vector4(314.52, -584.19, 44.2, 337.02), taken = false, model = 1631638868},
        [2] = {coords = vector4(317.64, -585.31, 44.2, 330.72), taken = false, model = 1631638868},
        [3] = {coords = vector4(354.12, -593.12, 43.1, 336.32), taken = true, model = 2117668672},
        [4] = {coords = vector4(350.79, -591.8, 43.1, 336.32), taken = true, model = 2117668672},
        [5] = {coords = vector4(346.99, -590.48, 43.1, 336.32), taken = true, model = 2117668672},
        [6] = {coords = vector4(360.32, -587.19, 43.02, 152.08), taken = true, model = -1091386327},
        [7] = {coords = vector4(349.82, -583.33, 43.02, 152.08), taken = true, model = -1091386327},
        [8] = {coords = vector4(314.56, -584.27, 44.2, 337.19), taken = true, model = -1091386327},
	--- paleto
